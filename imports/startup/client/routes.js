...
Router.register({
  ...
  transactions: async parameters => {
    Log.log(['debug', 'routing'], 'Viewing admin:', parameters)
    await import('/imports/ui/pages/transactions/transactionsPage.js')
    Router.set('currentPage', 'transactions')
    Layout.set('body', 'transactionsPage')
  },
